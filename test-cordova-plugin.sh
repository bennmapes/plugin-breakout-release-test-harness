#set -e
plugins=("https://git-wip-us.apache.org/repos/asf/cordova-plugin-device-motion.git" "https://git-wip-us.apache.org/repos/asf/cordova-plugin-device-orientation.git" "https://git-wip-us.apache.org/repos/asf/cordova-plugin-vibration.git" "https://git-wip-us.apache.org/repos/asf/cordova-plugin-battery-status.git" "https://git-wip-us.apache.org/repos/asf/cordova-plugin-splashscreen.git" "https://git-wip-us.apache.org/repos/asf/cordova-plugin-inappbrowser.git" "https://git-wip-us.apache.org/repos/asf/cordova-plugin-contacts.git") 
pluginID=("org.apache.cordova.core.AccelListener" "org.apache.cordova.core.CompassListener" "org.apache.cordova.core.Notification" "org.apache.cordova.core.BatteryListener" "org.apache.cordova.core.SplashScreen" "org.apache.cordova.core.InAppBrowser" "org.apache.cordova.core.contacts")
projectName=("deviceMotion" "deviceOrientation" "vibration" "battery" "splashscreen" "inappbrowser" "contacts")
